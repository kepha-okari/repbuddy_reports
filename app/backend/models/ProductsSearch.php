...
class ProductsSearch extends Products
{
    ...
    {
        return [
            [['id', 'client_id', 'category_id', 'in_stock', 'cost', 'created_by', 'updated_by'], 'integer'],
            [['name', 'description', 'inserted_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        {
            $query = Products::find()->where('client_id='.Yii::$app->user->identity->client_id);
        }else{
            $query = Products::find();
