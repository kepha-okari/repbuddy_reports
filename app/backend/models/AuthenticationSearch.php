...
/**
 * AuthenticationSearch represents the model behind the search form of `backend\models\Authentication`.
 */
class AuthenticationSearch extends Authentication
{
    ...
    public function search($params)
    {
        ...
        {
            $query = Authentication::find()->where('client_id='.Yii::$app->user->identity->client_id);
        }else{
            $query = Authentication::find();
