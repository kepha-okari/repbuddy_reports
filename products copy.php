...
<body>
    ...
    <script>
        let allProducts = 0;
        // Function to make a GET request to your server-side proxy and populate the product report table
        function fetchData() {
            
            const apiUrl = 'http://161.35.6.91/pharmacorp/backend/web/index.php/api/product-report'; // Replace with the actual URL of your server-side proxy
            ...
            fetch(apiUrl)
                ...
                .then(data => {
                    if (data.status) {
                        ...
                        // Update the "Total Products" value in the box-info section
